...
class AnswerService:
    ...
    async def create_answer(self, quiz_id: int, question_id: int, schema: CreateAnswerSchema) -> Answer:
        await self.question_serv.get_question(quiz_id, question_id)

        answer = Answer(description=schema.description, is_correct=schema.is_correct)
        return self.repo.create(answer)

    async def delete_answer(self, quiz_id: int, question_id: int, answer_id: int) -> None:
        await self.question_serv.get_question(quiz_id, question_id)
    ...
    async def update_answer(self, quiz_id: int, question_id: int, answer_id: int, schema: UpdateAnswerSchema) -> Answer:
        await self.question_serv.get_question(quiz_id, question_id)
    ...
    async def get_answer(self, quiz_id: int, question_id: int, answer_id: int) -> Answer:
        await self.question_serv.get_question(quiz_id, question_id)
    ...
    async def get_answers(self, quiz_id: int, question_id: int) -> list[Answer]:
